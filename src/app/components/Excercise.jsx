...
const Excercise = () => {
  return (
    <div className="bg-[#161E2A] container mx-auto pt-5 ">
      <div className="flex relative xl:mb-0 mb-4  gap-2 2xl:justify-between justify-center items-center md:mx-8 mx-4">
        <div className="sm:p-5 p-3 bg-[#0C1625] flex-wrap max-w-fit flex justify-center items-center gap-4  rounded-xl overflow-auto">
          <Workout
            main={
            ...
            style={
              "flex rounded-xl bg-[#D7F2F4] sm:w-[325px] sm:h-[180px] w-[270px] h-[170px] text-black justify-center items-center sm:px-4 px-2"
            }
            training={"Plates Training"}
          />
          <Workout
            ...
            style={
              "flex rounded-xl bg-[#FFDFDF] sm:w-[325px] sm:h-[180px] w-[270px] h-[170px] text-black justify-center items-center sm:px-4 px-2"
            }
          ...
          <Workout
            ...
            style={
              "flex rounded-xl bg-[#FBF6B5] sm:w-[325px] sm:h-[180px] w-[270px] h-[170px] text-black justify-center items-center sm:px-4 px-2"
            }
            training={"Crossfit Workout"}
          />
        </div>

        <div className=" xl:block hidden -mt-[150px] border-[2px] border-[#999999ba] rounded-[40px]">
          <div className="relative w-[220px] h-[400px] bg-black rounded-[40px] border-[10px] border-black overflow-hidden shadow-lg">
      ...
      <div className="bg-[#FBFBFB] flex py-3  -rotate-2 justify-center items-center md:-mt-4 mt-2 text-sm mb-7 overflow-hidden">
        <div className="animate-scroll flex space-x-3 w-fit whitespace-nowrap">
          ...
          />
          <ServicesScroll
            text={"🚶‍♂️ Treadmill Running/Walking"}
            className={
