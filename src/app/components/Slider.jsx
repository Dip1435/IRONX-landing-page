...
const Slider = () => {
  ...
  return (
    <div
      className="relative container mx-auto sm:h-[872px] h-[600px] bg-cover bg-center"
    ...
    >
      ...
      {/* Slider Content */}
      <div className="absolute inset-0 container mx-auto flex flex-col justify-center items-center text-white text-center px-4 gap-4">
        <div className="bg-[#FFD429] md:absolute top-[250px] left-[300px] text-black px-3 py-2 rounded-full text-[12px] md:text-[16px] font-medium">
        ...
        <p className="text-sm lg:text-lg mt-4 max-w-lg lg:max-w-2xl font-medium text-white">
